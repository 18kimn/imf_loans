...
async function drawMap(
  ...
  const canvas = select("#introMapContainer")
    ...
    .attr(
      "aria-label",
      "A world map rotates steadily on the screen and shifts between several different map projections. Countries on the world map transition between red and black."
    )
